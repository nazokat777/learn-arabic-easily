...
class _VocabStageState extends State<VocabStage> {
  ...
  void _buildQuestion() {
    ...
    final distract =
        _pool.where((v) => v.uz != word.uz).map((v) => v.uz).toSet().toList()
          ..shuffle(_rnd);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        _header(),
        Expanded(
          child: _phase == _Phase.learn ? _learnView() : _practiceView(),
        ),
      ],
    );
  }
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                _phase == _Phase.learn ? 'Tanishuv' : 'Mashq',
                style: const TextStyle(
                  fontSize: 12.5,
  ...
  /// Kartaning bir yuzi. Old tomoni oq va sokin; orqa tomoni ([accent])
  /// oltin hoshiya va xira girih bilan — «javob ochildi» degan his.
  Widget _cardFace({
    required String head,
    required QiroatVocab v,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: (accent ? AppColors.gold : Colors.black).withValues(
              alpha: accent ? 0.20 : 0.06,
            ),
            blurRadius: 24,
